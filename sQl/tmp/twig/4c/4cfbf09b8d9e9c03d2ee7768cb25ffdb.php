...
echo _gettext("Go");
    ...
    {
        return new Source("", "table/insert/get_head_and_foot_of_insert_row_table.twig", "/workspaces/devbase-CI/sQl/templates/table/insert/get_head_and_foot_of_insert_row_table.twig");
    }
}
